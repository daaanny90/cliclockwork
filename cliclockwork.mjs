...
const CONFIG_PATH = path.join(os.homedir(), '.config/cliclockwork/settings.json');
...
program
    ...
    .description('Start a timer for the given a ticket name. Starting a new timer will stop the current one.')
    .action(startTimer);
